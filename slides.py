...
class c_Methodology(Slide, ThreeDScene):
    def construct(self):
        ...
        self.play(TransformMatchingShapes(enron_params[0], avg_params[0], transform_mismatches=True), TransformMatchingShapes(enron_params[1], avg_params[1], transform_mismatches=True), FadeOut(contracts_params))
